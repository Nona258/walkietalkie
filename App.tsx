...
export default function App() {
  ...
  // Note: live GPS tracking is handled by a headless component mounted below.
    ...
    <View style={{ flex: 1 }}>
      {currentPage === 'signin' ? (
        ...
        <View style={{ flex: 1 }}>
          ...
          {/* Headless live location tracker (no UI rendered) */}
          <LiveLocationTracker enabled={currentPage === 'dashboard' && userRole !== 'admin'} userId={user?.id || null} />
