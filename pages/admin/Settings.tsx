      ...
      >
        ...
        >
          ...
          <View className="flex-row items-center gap-2.5">
            ...
            <View
              className="items-center justify-center border rounded-full w-9 h-9 bg-[#237227] border-[#237227]"
            >
              <Text className="text-[11px] font-bold text-[#f8fafb]">
                {initials}
              </Text>
            </View>
          </View>
        ...
        <View className={`${isWebView ? 'px-6 py-6' : 'px-4 py-4'} w-full`}>
          <View className={`${isWebView ? 'flex-row' : 'flex-col'} items-stretch ${isWebView ? 'gap-5' : 'gap-4'}`}>
            ...
            <View className={isWebView ? 'w-[280px] shrink-0 self-stretch' : 'w-full'}>
              ...
              >
                <View className="items-center w-full">
                  <View
                    className={`${isWebView ? 'w-[72px] h-[72px]' : 'w-16 h-16'} rounded-full items-center justify-center border-2 mb-3.5 bg-[#f8fafb] border-[#237227]`}
                  >
                  ...
                  {[
                    ...
                    <View key={row.label} className="w-full flex-row items-center mb-2.5 gap-2.5">
                      ...
                      >
                        <Ionicons name={row.icon as any} size={13} color={COLORS.cloudMist} />
                      </View>
                      <View className="flex-1">
                        <Text className="text-[10px] text-[#8fa88f]">
                          {row.label}
                        </Text>
                ...
                <View className="w-full">
                  ...
                  {!isEditMode ? (
                    <TouchableOpacity
                      ...
                      className="w-full flex-row items-center justify-center rounded-[9px] py-2.5 bg-[#237227] gap-1.5"
                    >
                    ...
                    <View className="w-full gap-2">
                      <TouchableOpacity
                        onPress={handleSave}
                        className="h-[38px] rounded-[9px] items-center justify-center flex-row bg-[#237227] gap-[5px]"
                      >
            ...
            <View className={`${isWebView ? 'flex-1' : 'w-full'} gap-4`}>
              <View
                className={`bg-white border border-[#e5e7eb] rounded-2xl ${isWebView ? 'p-6' : 'p-4'}`}
              >
                ...
                <View className="gap-[14px]">
                  ...
                  <View className="gap-1.5">
                    ...
                    <View
                      className="flex-row items-center gap-2 px-3 h-10 rounded-[9px] border bg-[#f8fafb] border-[#e5e7eb]"
                    >
