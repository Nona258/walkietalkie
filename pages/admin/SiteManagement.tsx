      ...
      // Add popup with site info
        marker.bindPopup(`
          <div style="font-family: sans-serif;">
            ...
            <span style="font-size: 12px; color: #666;">${companyOptions.find(opt => opt.id === selectedSite.company)?.name || 'No company selected'}</span><br/>
            ...
            {sites.length === 0 ? (
              ...
              sites.map((site, index) => (
                ...
                >
                  ...
                  {/* Company */}
                  <Text className="flex-1 text-sm text-stone-600">{companyOptions.find(opt => String(opt.id) === String(site.company))?.name || 'No company selected'}</Text>
                  ...
                  <View className="flex-row items-start">
                    ...
                    <View className="flex-1">
                      ...
                      <View className="flex-row items-center mb-1.5">
                        ...
                        <Text className="text-xs text-stone-600 ml-1.5">{branchOptions.find(opt => opt.id === site.branch_id)?.name || 'No branch selected'}</Text>
                      </View>
              ...
              {selectedSite && selectedSite.latitude && selectedSite.longitude && (
                <View className="mt-4 bg-stone-50 px-4 py-3 rounded-lg">
                  ...
                  <View className="flex-row items-center mb-2">
                    ...
                    <Text className="text-sm text-stone-600 ml-2">{branchOptions.find(opt => opt.id === selectedSite.branch_id)?.name || 'No branch selected'}</Text>
                  </View>
                  <View className="flex-row items-center">
