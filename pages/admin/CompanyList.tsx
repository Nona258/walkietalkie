...
function CompanyRow({ company, isLast, onPress, onDelete }: { company: Company; isLast: boolean; onPress: () => void; onDelete: () => void }) {
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.7}
    ...
    >
      ...
      <View style={{ width: 36, alignItems: 'center' }}>
        <TouchableOpacity
          ...
          style={{ width: 28, height: 28, borderRadius: 7, backgroundColor: COLORS.cloudMist, borderWidth: 1, borderColor: COLORS.border, alignItems: 'center', justifyContent: 'center' }}
        >
        ...
        <View style={{ paddingHorizontal: 24, paddingTop: 24, paddingBottom: 48, width: '100%' }}>
          ...
          <View style={{ backgroundColor: COLORS.white, borderRadius: 14, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden', width: '100%' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingVertical: 12, borderTopWidth: 1, borderTopColor: COLORS.borderLight, backgroundColor: COLORS.cloudMist }}>
              <Text style={{ fontSize: 12, color: COLORS.textMuted }}>Showing {filtered.length} of {companies.length} companies</Text>
        ...
        <Pressable style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.2)', justifyContent: 'center', alignItems: 'center', padding: 24 }} onPress={() => setIsAddModalOpen(false)}>
          <Pressable style={{ width: '100%', maxWidth: 460, backgroundColor: COLORS.white, borderRadius: 16, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden' }} onPress={() => {}}>
            ...
            <View style={{ flexDirection: 'row', gap: 10, paddingHorizontal: 24, paddingBottom: 24 }}>
              <TouchableOpacity onPress={() => setIsAddModalOpen(false)} style={{ flex: 1, height: 40, borderRadius: 9, borderWidth: 1, borderColor: COLORS.border, alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.cloudMist }}>
