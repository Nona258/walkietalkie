  ...
  return (
    <View className="w-full flex-1 bg-gray-50">
      ...
      <ScrollView
        ...
        bounces={false}>
        {/* Header */}
        <View className="flex-row items-center justify-between bg-white px-6 pb-6 pt-12">
          <View className="flex-1 flex-row items-center gap-3">
            <View className="h-14 w-14 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-green-100">
        ...
        <Modal
          ...
          <Pressable
            ...
            <Pressable className="w-full max-w-md rounded-2xl bg-white p-5" onPress={() => {}}>
              ...
              <TouchableOpacity
                className="mt-3 w-full rounded-xl bg-green-600 py-3"
                onPress={() => {
                  void loadNotifications();
                  void loadUnreadCount();
                }}
                disabled={notificationsLoading}>
                <Text className="text-center text-sm font-semibold text-white">Refresh</Text>
              </TouchableOpacity>
            </Pressable>
          </Pressable>
        </Modal>
        ...
        {/* Content */}
        <View className="w-full bg-gray-50 px-6 py-2 pb-32">
          {/* Stats Grid */}
          ...
          <View className="mt-1 w-full">
            ...
            <View className="w-full rounded-2xl border border-gray-200 bg-white p-4">
              {/* Location */}
              <View className="mb-2 flex-row items-center rounded-xl bg-gray-50 p-3">
