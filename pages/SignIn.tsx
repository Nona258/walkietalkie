...
export default function SignIn({ onNavigateToSignUp, onSignInSuccess }: SignInProps) {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      if (data?.user) {
        // Mark user as online and fetch their role and approval status
        try {
          ...
          const isApproved = userData?.is_approved || isAdmin;
          ...
          console.error('Failed to check user status or fetch role:', err);
